        ...
        <div className="mx-auto flex h-(--scroll-padding-top) max-w-7xl items-center gap-4 px-6 lg:px-10">
          ...
          <div className="flex flex-1 items-center justify-end gap-4">
            <div className="flex shrink-0 items-center gap-5">
              ...
              <a
                className="inline-flex h-9 shrink-0 items-center justify-center gap-2 rounded-xl px-3 py-1 text-sm/7 font-medium text-(--color-text) transition-colors duration-(--duration-normal) hover:bg-text/10 max-lg:hidden"
                href="/contact-sales"
              >
                Contact sales
              </a>
              ...
              >
                Download
                <AppleIcon className="inline-block size-4 opacity-90 group-hover:animate-icon-bounce" />
                <kbd className="ml-1 inline-flex h-5 w-5 shrink-0 items-center justify-center rounded bg-current/10 font-sans text-[11px] font-semibold leading-none uppercase opacity-60">
                  D
                </kbd>
              </a>
            </div>
